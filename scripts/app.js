...
turtle.src = "arcade_game-frogger/asset/turtles.png";

const log = new Image();
// log.src = "../asset/log.png";
log.src = "arcade_game-frogger/asset/log.png";

const car = new Image();
// car.src = "../asset/cars.png";
car.src = "arcade_game-frogger/asset/cars.png";

let numberOfCars = 3;

const frogSprite = new Image();
// frogSprite.src = "../asset/frog_spritesheet.png";
frogSprite.src = "arcade_game-frogger/asset/frog_spritesheet.png";

// sound effects

const jumpSound = new Audio();
jumpSound.src = "arcade_game-frogger/asset/jump.wav";